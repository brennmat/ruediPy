...
\path{python/classes/rgams_SRS.py}\par
...
\path{python/classes/selectorvalve_VICI.py}\par
...
\path{python/classes/selectorvalve_compositeVICI.py}\par
...
\path{python/classes/pressuresensor_WIKA.py}\par
...
\path{python/classes/pressuresensor_OMEGA.py}\par
...
\path{python/classes/temperaturesensor_MAXIM.py}\par
...
\path{python/classes/datafile.py}\par
...
\path{python/classes/misc.py}\par
