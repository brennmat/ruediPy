...
\path{ruedi/ruediPy/python/classes/rgams_SRS.py}\par
...
\path{ruedi/ruediPy/python/classes/selectorvalve_VICI.py}\par
...
\path{ruedi/ruediPy/python/classes/pressuresensor_WIKA.py}\par
...
\path{ruedi/ruediPy/python/classes/temperaturesensor_MAXIM.py}\par
...
\path{ruedi/ruediPy/python/classes/datafile.py}\par
...
\path{ruedi/ruediPy/python/classes/misc.py}\par
