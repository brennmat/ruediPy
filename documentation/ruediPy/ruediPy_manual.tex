...
\ruediPy\ is developed on Linux and Mac OS X systems, but should also work on any other system that runs Python and GNU Octave. \ruediPy\ has been reported to (partially) work on Windows. Linux is the recommended choice and is assumed throughout this manual. Python 3.0 or newer is recommended.\par
