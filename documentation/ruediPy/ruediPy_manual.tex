...
\texttt{sudo apt-get install subversion python-pip python-serial python-matplotlib python-scipy}\\
\texttt{pip install pydigitemp}\\

\item Download ruediPy:\par
\texttt{svn co https://github.com/brennmat/ruediPy.git/trunk ~/ruediPy}
...
\texttt{echo export PYTHONPATH=~/ruediPy/python >> .profile}
...
\item Prepare directory for ruediPy data files:\par
\texttt{mkdir ~/ruedi_data}
