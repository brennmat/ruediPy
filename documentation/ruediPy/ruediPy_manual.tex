...
\texttt{echo export PYTHONPATH=\path{~/ruediPy/python} >> \path{~/.profile}}
...
\item Add \ruediPy\ and the measurement scripts to the Python and Shell searchpaths (this requires the user to log out and log back in to become active):\par
\texttt{echo export PYTHONPATH=\$PYTHONPATH:\path{/home/mRdemo/ruediPy/python} >> \path{~/.profile}}\\
\texttt{echo export PYTHONPATH=\$PYTHONPATH:\path{/home/mRdemo/scripts} >> \path{~/.profile}}\\
\texttt{echo export PATH=\$PATH:\path{/home/mRdemo/scripts} >> \path{~/.profile}}
