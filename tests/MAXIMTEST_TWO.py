...
from ruedipy.temperaturesensor_MAXIM	import temperaturesensor_MAXIM
...
while 1:
	T1,unit1 = TSENS1.temperature('nofile')
	T2,unit2 = TSENS2.temperature('nofile')
	print ( str(T1) + ' ' + unit1 + '    ' + str(T2) + ' ' + unit2 )
