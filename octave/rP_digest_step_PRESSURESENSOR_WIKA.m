...
%%%% % the code below is a copy of rP_digest_step_RGA_SRS, which may serve as a template for implementation of this function
%%%% 
...
%%%% 	MS  = getfield (RAW,sensor_name);	% MS data
%%%% else
%%%% 	error (sprintf('rP_digest_step: found no MS data for ''%s''.',sensor_name))
%%%% end
%%%% 
